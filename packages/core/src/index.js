...
function migration() {
    return __awaiter(this, void 0, void 0, function () {
        var dbConfig, migrations_path, client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    migrations_path = require("migrations/");
                    console.log(migrations_path);
                    client = new pg.Client(dbConfig) // or a Pool, or a PoolClient
                    ;
                ...
                case 2:
                    _a.trys.push([2, , 4, 6]);
                    return [4 /*yield*/, migrate({ client: client }, "migrations/")];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
